...
public class SmartRecognizeRequestMessage {
	...
	public static SmartRecognizeRequestMessage cer_decode(InputStream in) throws IOException {
		return (SmartRecognizeRequestMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static SmartRecognizeRequestMessage der_decode(InputStream in) throws IOException {
		return (SmartRecognizeRequestMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static SmartRecognizeRequestMessage per_decode(boolean align, InputStream in) throws IOException {
		return (SmartRecognizeRequestMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
