...
public class SmartFaultRequestMessage {
	...
	public static SmartFaultRequestMessage cer_decode(InputStream in) throws IOException {
		return (SmartFaultRequestMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static SmartFaultRequestMessage der_decode(InputStream in) throws IOException {
		return (SmartFaultRequestMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static SmartFaultRequestMessage per_decode(boolean align, InputStream in) throws IOException {
		return (SmartFaultRequestMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
