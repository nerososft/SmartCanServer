...
public class LogoutResponseMessage {
	...
	public static LogoutResponseMessage cer_decode(InputStream in) throws IOException {
		return (LogoutResponseMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static LogoutResponseMessage der_decode(InputStream in) throws IOException {
		return (LogoutResponseMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static LogoutResponseMessage per_decode(boolean align, InputStream in) throws IOException {
		return (LogoutResponseMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
