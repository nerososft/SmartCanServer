...
public enum EPSSTA {
	...
	public static EPSSTA cer_decode(InputStream in) throws IOException {
		return (EPSSTA)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static EPSSTA der_decode(InputStream in) throws IOException {
		return (EPSSTA)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static EPSSTA per_decode(boolean align, InputStream in) throws IOException {
		return (EPSSTA)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
