...
public class SmartPlatonningResponseMessage {
	...
	public static SmartPlatonningResponseMessage cer_decode(InputStream in) throws IOException {
		return (SmartPlatonningResponseMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static SmartPlatonningResponseMessage der_decode(InputStream in) throws IOException {
		return (SmartPlatonningResponseMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static SmartPlatonningResponseMessage per_decode(boolean align, InputStream in) throws IOException {
		return (SmartPlatonningResponseMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
