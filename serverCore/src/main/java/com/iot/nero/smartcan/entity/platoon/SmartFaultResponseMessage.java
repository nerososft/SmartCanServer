...
public class SmartFaultResponseMessage {
	...
	public static SmartFaultResponseMessage cer_decode(InputStream in) throws IOException {
		return (SmartFaultResponseMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static SmartFaultResponseMessage der_decode(InputStream in) throws IOException {
		return (SmartFaultResponseMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static SmartFaultResponseMessage per_decode(boolean align, InputStream in) throws IOException {
		return (SmartFaultResponseMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
