...
public enum VALIDWHEELSPEEDRL {
	...
	public static VALIDWHEELSPEEDRL cer_decode(InputStream in) throws IOException {
		return (VALIDWHEELSPEEDRL)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static VALIDWHEELSPEEDRL der_decode(InputStream in) throws IOException {
		return (VALIDWHEELSPEEDRL)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static VALIDWHEELSPEEDRL per_decode(boolean align, InputStream in) throws IOException {
		return (VALIDWHEELSPEEDRL)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
