...
import com.iot.nero.smartcan.timer.ClientTicker;
import com.iot.nero.smartcan.timer.DataBaseTicker;
...
public class SmartCanBootstrap {
    ...
    public static Map<SocketChannel,Tick> tickMap;
    ...
    private void initTable() throws NoSuchMethodException, InstantiationException, IllegalAccessException, IOException {
        ...
        DataBaseTicker dataBaseTicker = new DataBaseTicker(dataBase,20*1000);
        dataBaseTicker.start();
    }

    private void startTicker() throws NoSuchMethodException, InstantiationException, IOException, IllegalAccessException {
        tickMap = new HashMap<>();
        ClientTicker clientTicker = new ClientTicker(0,1000*60*2L);
        clientTicker.start();
    }
