...
public enum LOWBEAMINDICATOR {
	...
	public static LOWBEAMINDICATOR cer_decode(InputStream in) throws IOException {
		return (LOWBEAMINDICATOR)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static LOWBEAMINDICATOR der_decode(InputStream in) throws IOException {
		return (LOWBEAMINDICATOR)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static LOWBEAMINDICATOR per_decode(boolean align, InputStream in) throws IOException {
		return (LOWBEAMINDICATOR)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
