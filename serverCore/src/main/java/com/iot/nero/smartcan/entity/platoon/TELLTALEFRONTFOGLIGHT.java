...
public enum TELLTALEFRONTFOGLIGHT {
	...
	public static TELLTALEFRONTFOGLIGHT cer_decode(InputStream in) throws IOException {
		return (TELLTALEFRONTFOGLIGHT)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static TELLTALEFRONTFOGLIGHT der_decode(InputStream in) throws IOException {
		return (TELLTALEFRONTFOGLIGHT)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static TELLTALEFRONTFOGLIGHT per_decode(boolean align, InputStream in) throws IOException {
		return (TELLTALEFRONTFOGLIGHT)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
