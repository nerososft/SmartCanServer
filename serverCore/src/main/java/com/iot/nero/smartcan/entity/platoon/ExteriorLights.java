...
public enum ExteriorLights {
	...
	public static ExteriorLights cer_decode(InputStream in) throws IOException {
		return (ExteriorLights)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static ExteriorLights der_decode(InputStream in) throws IOException {
		return (ExteriorLights)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
