...
public class SmartStrategyResponseMessage {
	...
	public static SmartStrategyResponseMessage cer_decode(InputStream in) throws IOException {
		return (SmartStrategyResponseMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static SmartStrategyResponseMessage der_decode(InputStream in) throws IOException {
		return (SmartStrategyResponseMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static SmartStrategyResponseMessage per_decode(boolean align, InputStream in) throws IOException {
		return (SmartStrategyResponseMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
