...
public class SmartDissolveResponseMessage {
	...
	public static SmartDissolveResponseMessage cer_decode(InputStream in) throws IOException {
		return (SmartDissolveResponseMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static SmartDissolveResponseMessage der_decode(InputStream in) throws IOException {
		return (SmartDissolveResponseMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static SmartDissolveResponseMessage per_decode(boolean align, InputStream in) throws IOException {
		return (SmartDissolveResponseMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
