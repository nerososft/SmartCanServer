...
public class LogoutRequestMessage {
	...
	public static LogoutRequestMessage cer_decode(InputStream in) throws IOException {
		return (LogoutRequestMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static LogoutRequestMessage der_decode(InputStream in) throws IOException {
		return (LogoutRequestMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static LogoutRequestMessage per_decode(boolean align, InputStream in) throws IOException {
		return (LogoutRequestMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
