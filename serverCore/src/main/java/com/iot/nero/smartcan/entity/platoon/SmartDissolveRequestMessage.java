...
public class SmartDissolveRequestMessage {
	...
	public static SmartDissolveRequestMessage cer_decode(InputStream in) throws IOException {
		return (SmartDissolveRequestMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static SmartDissolveRequestMessage der_decode(InputStream in) throws IOException {
		return (SmartDissolveRequestMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static SmartDissolveRequestMessage per_decode(boolean align, InputStream in) throws IOException {
		return (SmartDissolveRequestMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
