...
public enum HIGHBEAMINDICATOR {
	...
	public static HIGHBEAMINDICATOR cer_decode(InputStream in) throws IOException {
		return (HIGHBEAMINDICATOR)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static HIGHBEAMINDICATOR der_decode(InputStream in) throws IOException {
		return (HIGHBEAMINDICATOR)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static HIGHBEAMINDICATOR per_decode(boolean align, InputStream in) throws IOException {
		return (HIGHBEAMINDICATOR)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
