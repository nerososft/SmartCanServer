...
public enum TCUTGSMode {
	...
	public static TCUTGSMode cer_decode(InputStream in) throws IOException {
		return (TCUTGSMode)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static TCUTGSMode der_decode(InputStream in) throws IOException {
		return (TCUTGSMode)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static TCUTGSMode per_decode(boolean align, InputStream in) throws IOException {
		return (TCUTGSMode)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
