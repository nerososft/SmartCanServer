...
public class SmartStrategyRequestMessage {
	...
	public static SmartStrategyRequestMessage cer_decode(InputStream in) throws IOException {
		return (SmartStrategyRequestMessage)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static SmartStrategyRequestMessage der_decode(InputStream in) throws IOException {
		return (SmartStrategyRequestMessage)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static SmartStrategyRequestMessage per_decode(boolean align, InputStream in) throws IOException {
		return (SmartStrategyRequestMessage)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
