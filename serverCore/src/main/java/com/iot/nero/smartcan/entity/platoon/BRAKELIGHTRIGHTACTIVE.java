...
public enum BRAKELIGHTRIGHTACTIVE {
	...
	public static BRAKELIGHTRIGHTACTIVE cer_decode(InputStream in) throws IOException {
		return (BRAKELIGHTRIGHTACTIVE)TYPE.decode(in, EncodingRules.CANONICAL_ENCODING_RULES, CONV);
	}
	...
	public static BRAKELIGHTRIGHTACTIVE der_decode(InputStream in) throws IOException {
		return (BRAKELIGHTRIGHTACTIVE)TYPE.decode(in, EncodingRules.DISTINGUISHED_ENCODING_RULES, CONV);
	}
	...
	public static BRAKELIGHTRIGHTACTIVE per_decode(boolean align, InputStream in) throws IOException {
		return (BRAKELIGHTRIGHTACTIVE)TYPE.decode(in, align? EncodingRules.ALIGNED_PACKED_ENCODING_RULES:EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
	}
